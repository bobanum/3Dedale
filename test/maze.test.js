...
import { Wanderer } from "../src/Wanderer.js";
import { AStarSolver } from "../src/AStarSolver.js";
...
test("maze exports JSON with dimensions and typed edges", () => {
    ...
    assert.equal(json.dimensions.width, 1);
    assert.equal(json.dimensions.height, 1);
    assert.equal(json.dimensions.depth, 2);
